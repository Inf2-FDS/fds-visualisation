...
\usepackage{times}
\usepackage[top=0.3in,left=0.3in,right=0.3in,bottom=0.38in,landscape,
...
\usepackage{multicol}
\usepackage{enumitem}
\setlist[itemize]{topsep=0pt,leftmargin=5pt,labelsep=1pt,noitemsep,parsep=0pt}
\setlist[itemize,1]{label=\footnotesize\textbullet}
\frenchspacing
...
\begin{document}
\fancyfoot[C]{
  \footnotesize Version 2.0-beta3 \copyright 2022-2025 by David Sterratt, licensed under CC
  BY-SA 4.0
